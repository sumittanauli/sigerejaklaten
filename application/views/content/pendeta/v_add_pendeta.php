...
<head>
	<title>Form Tambah Data Pendeta</title>
	<!-- CSS only CDN -->
			...
			<div class="row">
				<div class="col-6">
					...
					<div class="form-group">
						...
						<input required type="text" class="form-control" name="asal_pendeta">
					</div>
					<div class="form-group">
						<label for="pendidikan_pendeta">Pendidikan</label>
						<select required name="pendidikan_pendeta" id="pendidikan_pendeta" class="form-control">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<input required type="date" class="form-control" name="tahun_mulai_pendeta">
					</div>
					<div class="form-group">
						<label class="form-label">Tahun Selesai</label>
						<input required type="date" class="form-control" name="tahun_selesai_pendeta">
					</div>
					<div class="form-group">
						<label class="form-label">Periode</label>
						<input required type="text" class="form-control" name="periode_pendeta">
					</div>
					<div class="form-group">
						<label for="status_pendeta">Status</label>
						<select class="form-control" name="status_pendeta" id="status_pendeta" required>
